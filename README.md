...
Documentation: https://github.com/bazelbuild/buildtools/blob/10.0.1/buildozer/README.md
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/bazel_buildozer-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/bazel_buildozer-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add bazel_buildozer
# for installing globally
pixi global install bazel_buildozer
```
...
It is possible to list all of the versions of `bazel_buildozer` available on your platform:
...
```
pixi search bazel_buildozer --channel conda-forge
```
...
* [@rymndhng](https://github.com/rymndhng/)
